...
private:
    ...
    bool getAngleBetweenActors(Actor *a, Actor *b, int dist, int& angle) const;
    bool getOverlap(Actor *a, double x, double y) const;
    void checkInitOverlap(double &x, double &y);

    
    void generateRandCoord(double &x, double &y);
